...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!parsed) {
    return {
      title: 'UTC Offset Not Found — GlobalTime',
    };
  }
  ...
  return {
    ...
    alternates: {
      canonical: `https://globaltime.org/utc-offset/${offset.toLowerCase()}`,
    },
    openGraph: {
      title: `${parsed.formattedOffset} Time Zone — GlobalTime`,
      description: `Live atomic clock and member cities in ${parsed.formattedOffset}.`,
      url: `https://globaltime.org/utc-offset/${offset.toLowerCase()}`,
    },
  };
}
  ...
  const jsonLd = {
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: parsed.formattedOffset, item: `https://globaltime.org/utc-offset/${offset.toLowerCase()}` },
      ],
    },
  };
