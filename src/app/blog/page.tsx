...
const content = HUB_PAGES_CUSTOM_CONTENT['/blog'];
  ...
  return (
    <div className="max-w-[1720px] w-full mx-auto px-4 sm:px-8 lg:px-12 py-10 space-y-10">
      ...
      <JsonLd
        ...
        data={{
          name: content.h1,
          category: "PublicationApplication",
          description: content.description
        }}
      />

      <BlogIndexClient h1Title={content.h1} description={content.description} />
            ...
            {content.headings.slice(1).map((heading, idx) => (
              <div key={idx} className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/70 dark:border-slate-800 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                  Deep dives into global timezone legislation, NTP network architecture, leap second debates, and distributed work.
                </p>
              </div>
            ))}
          </div>
      ...
      <div className="pt-4 border-t border-slate-200 dark:border-slate-800 max-w-4xl mx-auto">
        <FaqAccordion items={content.faqs} title="Frequently Asked Questions: Horological Insights" />
      </div>
