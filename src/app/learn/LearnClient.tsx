...
export function LearnClient({ h1Title, description }: Props) {
    ...
    <div className="space-y-10">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-3">
        ...
        <h1 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight">
          {h1Title || "How Time Works on Planet Earth"}
        </h1>
        <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 font-medium">
          {description || "A visual, scientific encyclopedia exploring the mechanics of atomic clocks, international time zones, and circadian biology."}
        </p>
      </div>
