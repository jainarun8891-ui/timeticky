...
export const HUB_PAGES_CUSTOM_CONTENT: Record<string, HubPageCustomContent> = {
  "/": {
    ...
    "title": "Exact Time Now: What Time Is It Right Now? (Atomic Clock & Seconds)",
    "description": "Check the exact time right now with live running seconds synchronized to official atomic time. Compare current local time in 500+ world cities with zero drift.",
  ...
  "/atomic-clock": {
    ...
    "path": "/atomic-clock",
    "category": "1.0 Clocks & Live Timekeeping",
    "title": "Official Atomic Clock Online — Exact Time with Seconds (NIST Synced)",
    "description": "Check the exact time right now with our official online atomic clock. Displays live Stratum-1 NIST & UTC time down to the millisecond with real-time drift check.",
    "h1": "Official Online Atomic Clock & Precision Time Calibrator",
    "headings": [
  ...
  "/timer": {
    ...
    "path": "/timer",
    "category": "1.0 Clocks & Live Timekeeping",
    "title": "Online Countdown Timer — 5, 10, 15 Minute Full Screen Timer & Alarm",
    "description": "Start a free online countdown timer with loud alarm sound. Instant presets for 1, 5, 10, 15, and 30 minutes, full screen mode, and pause/reset controls.",
  ...
  "/converter": {
    ...
    "title": "Time Zone Converter Calculator — Compare Times & Schedule Meetings",
    "description": "Interactive time zone converter calculator. Compare local times across 500+ world cities, find overlapping business hours, and schedule global calls in 1 click.",
    "h1": "Time Zone Converter Calculator & Meeting Planner",
    "headings": [
  ...
  "/time-zones": {
    ...
    "path": "/time-zones",
    "category": "3.0 Global Geography, Cities & Timezones",
    "title": "All Time Zones: Complete World Time Zones List (UTC & GMT Offsets)",
    "description": "Explore all time zones across the globe. Compare comparative time zones, check UTC & GMT offsets, standard abbreviations, and find which countries belong to each zone.",
    "h1": "All World Time Zones & UTC/GMT Offset Directory",
    "headings": [
  ...
  "/united-states-time-now": {
    ...
    "category": "3.0 Global Geography, Cities & Timezones",
    "title": "Current Time in United States Now — All 6 US Time Zones Live Clocks",
    "description": "What time is it in the US right now? Live atomic clocks for Eastern, Central, Mountain, Pacific, Alaska, and Hawaii time zones with DST status and map.",
    "h1": "Current Time in United States Right Now (All 6 Zones)",
    "headings": [
  ...
  "/world-map": {
    ...
    "path": "/world-map",
    "category": "3.0 Global Geography, Cities & Timezones",
    "title": "Interactive World Time Zone Map — All Time Zones & Solar Shadow",
    "description": "Interactive world time zone map. Compare all time zones and local times across 500+ cities, watch the real-time day/night solar shadow, and explore comparative zones.",
    "h1": "Interactive World Time Zone Map & Live Day/Night Tracker",
    "headings": [
  ...
  "/sun": {
    ...
    "title": "What Time is Sunset & Sunrise Today? Live Solar Calculator & Twilight",
    "description": "Find the exact sunset and sunrise times for your city today. Includes pre-dawn civil twilight, golden hour, dusk, solar noon, and total daylight hours calculator.",
    "h1": "What Time is Sunset & Sunrise Today? Live Solar Calculator",
    "headings": [
  ...
  "/moon": {
    ...
    "path": "/moon",
    "category": "4.0 Astronomy, Solar & Daylight Saving",
    "title": "Where is the Moon Tonight? Exact Moon Phase & Rise Times Today",
    "description": "See where the moon is tonight and track its current phase. Live lunar illumination percentage, exact moonrise and moonset times, and next full moon calendar.",
    "h1": "Where is the Moon Tonight? Live Moon Phase & Sky Position",
    "headings": [
  ...
  "/daylight-saving-time": {
    ...
    "category": "4.0 Astronomy, Solar & Daylight Saving",
    "title": "Daylight Saving Time 2026 & 2027 — Exact Dates When Clocks Change",
    "description": "Exact dates and times for Daylight Saving Time in 2026 and 2027 for the US, UK, and Europe. Find out when clocks spring forward and fall back without missing time.",
    "h1": "Daylight Saving Time 2026 & 2027 Schedule",
    "headings": [
